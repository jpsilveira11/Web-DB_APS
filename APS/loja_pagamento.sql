...
CREATE TABLE `pagamento` (
  ...
  `pagamento_valor` decimal(4,2) NOT NULL,
  `metodo_id` int DEFAULT NULL,
  `assinatura_id` int DEFAULT NULL,
  PRIMARY KEY (`pagamento_id`),
  KEY `metodo_id` (`metodo_id`),
  KEY `assinatura_id` (`assinatura_id`),
  CONSTRAINT `pagamento_ibfk_1` FOREIGN KEY (`metodo_id`) REFERENCES `metodo` (`metodo_id`),
  CONSTRAINT `pagamento_ibfk_2` FOREIGN KEY (`assinatura_id`) REFERENCES `assinatura` (`assinatura_id`)
...
-- Dump completed on 2023-05-08 20:18:17
